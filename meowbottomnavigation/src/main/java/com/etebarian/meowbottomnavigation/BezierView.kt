...
class BezierView : View {
    ...
    private val shadowHeight = dipf(context, 70)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        bezierOuterWidth = dipf(context, 144)
        bezierOuterHeight = dipf(context, 16)
        bezierInnerWidth = dipf(context, 148)
        bezierInnerHeight = dipf(context, 32)
    ...
    private fun calculateInner() {
        val extra = shadowHeight
        innerArray[0] = PointF(0f, bezierInnerHeight)
        innerArray[1] = PointF((bezierX - bezierInnerWidth), bezierInnerHeight)
        innerArray[2] = PointF(bezierX - bezierInnerWidth / 4, bezierInnerHeight)
        ...
        innerArray[6] = PointF(bezierX + bezierInnerWidth / 4, bezierInnerHeight )
        innerArray[7] = PointF(bezierX + bezierInnerWidth, bezierInnerHeight)
        innerArray[8] = PointF(width, bezierInnerHeight )
